...
useEffect(() => {
  ...
  useEffect(() => {
    const handleSectionChange = () => {
      ...
      if (scrollPosition < aboutRef.current.offsetTop - navbarHeight) {
        ...
        scrollPosition < projectsRef.current.offsetTop - navbarHeight
      ) {
  ...
  projects.forEach((p, i) => {
    if (p.hasGame) {
      newSrcs[i] = p.useWidget
        ? "https://itch.io/embed-upload/15902536?color=333333"
        : p.link;
    }
  });
  setIframeSrcs(newSrcs);
}, []);
  ...
  return (
    <div className="min-h-screen bg-stone-900 text-stone-100">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <a href="#home" className="text-2xl font-bold tracking-tight">
              ...
              <span className={`text-stone-100 ${navBarTextColors[activeSection]}`}>
                S
              </span>
            </a>
      ...
      {/* Home Section */}
      <section id="home" ref={homeRef} className="min-h-screen flex items-center pt-20 pb-32 px-6 scroll-mt-20">
        <div className="max-w-6xl mx-auto w-full space-y-6">
          ...
          <p className="text-xl font-bold text-stone-100 max-w-2xl leading-relaxed">
            Building software solutions and web applications that solve problems and connecting people is what I am all about.
          </p>
          <div className="flex gap-4 pt-4">
            <a href="#projects" className="bg-sky-600 text-white px-8 py-4 rounded-lg font-medium hover:bg-sky-700 transition-all hover:shadow-lg hover:-translate-y-0.5">
              View Projects
            </a>
            <a href="#contact" className="border-2 border-stone-100 text-stone-100 px-8 py-4 rounded-lg font-medium hover:bg-stone-100 hover:text-stone-900 transition-all">
              Get in Touch
            </a>
          </div>
          <div className="flex gap-6 pt-8">
            <a href="https://github.com/WJSchratt" target="_blank" rel="noopener noreferrer" className="text-stone-100 hover:text-sky-600 transition-colors">
              <Github className="w-6 h-6" />
            </a>
            <a href="https://www.linkedin.com/in/walter-schratt/" target="_blank" rel="noopener noreferrer" className="text-stone-100 hover:text-sky-600 transition-colors">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="mailto:schrattwalterdev@gmail.com" className="text-stone-100 hover:text-sky-600 transition-colors">
      ...
      {/* About Section */}
      <section id="about" tabIndex={-1}ref={aboutRef} className="py-32 px-6 bg-stone-600 scroll-mt-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-5xl font-bold text-stone-900 mb-6">About Me</h2>
            <div className="space-y-4 leading-relaxed">
              <p className="text-stone-100">
                I'm a full-stack developer with a passion for creating engaging digital experiences. I have an A.S. in Programming and Analysis and I am currently pursuing my Bachelors.
              </p>
              <p className="text-stone-900 font-bold">
                I love coding and problem solving but I love people even more. I like to engage, connect and solve problems together. I come from a customer service and sales background, so I understand how to identify client needs and build relationships.
              </p>
              <p className="text-stone-100">
                I grew up in Germany and I am fluent in both English and German. I have work experience in Germany and the USA. I love both countries for many reasons and my dream is to collaborate internationally one day.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-6 mt-12">
              <div className="space-y-2">
                ...
                <p className="text-sm text-stone-900 font-bold">React to Database</p>
              </div>
              <div className="space-y-2">
                <Globe className="w-8 h-8 text-stone-900" />
                <h3 className="font-bold">Bilingual</h3>
                <p className="text-sm text-stone-900 font-bold">German & English</p>
              </div>
              <div className="space-y-2">
                <Briefcase className="w-8 h-8 text-stone-900" />
                <h3 className="font-bold">EU Ready</h3>
                <p className="text-sm text-stone-900 font-bold">German Citizen</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-stone-900 rounded-2xl p-8 border-2 border-stone-800">
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-bold text-stone-500 mb-2">EDUCATION</h3>
                  <p className="font-semibold">Santa Fe College</p>
                  <p className="text-sm text-stone-100">A.S. Programming and Analysis</p>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-stone-500 mb-2">LOCATION</h3>
                  <p className="text-sm text-stone-100">Gainesville, FL</p>
                  <p className="text-sm text-stone-100">Open to Remote & Relocation</p>
                </div>
                <div>
                  <h3 className="text-sm font-bold text-stone-500 mb-2">LANGUAGES</h3>
      ...
      {/* Projects Section */}
      <section id="projects" tabIndex={-1} ref={projectsRef} className="py-32 px-6 bg-stone-50 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-bold mb-4 text-stone-900">Projects</h2>
          <p className="text-stone-600 mb-16 text-lg">Here is some stuff I made</p>

          <div className="space-y-12">
            {projects.map((project, index) => (
              <div key={index} className="bg-stone-400 rounded-2xl border-2 p-8 transition-colors">
                <div className="p-8">
                  {/* Project Header */}
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <h3 className="text-3xl font-bold text-stone-900 mb-2">{project.title}</h3>
                      <p className="text-stone-600 leading-relaxed max-w-3xl">{project.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    {/* Features */}
                    <div>
                      <h4 className="text-sm font-bold text-sky-700 mb-4">KEY FEATURES</h4>
                    ...
                    {/* Tech Stack */}
                    <div>
                      <h4 className="text-sm font-bold text-sky-700 mb-4">TECH STACK</h4>
                      <div className="flex flex-wrap gap-2 mb-6">
                        {project.tech.map((tech, i) => (
                          <span key={i} className="bg-sky-50 px-4 py-2 rounded-lg text-sm font-medium border border-sky-200 text-stone-800">
                            {tech}
                          </span>
                        ))}
                      </div>
      ...
      {/* Skills Section */}
      <section id="skills" ref={skillsRef} tabIndex={-1} className="py-32 px-6 bg-white scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-5xl font-bold mb-4 text-stone-900">Skills & Technologies</h2>
      ...
      {/* Contact Section */}
      <section id="contact" tabIndex={-1}  ref={contactRef} className="py-32 px-6 bg-stone-900 text-white scroll-mt-20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-5xl font-bold mb-6">Let's Work Together</h2>
          <p className="text-xl text-stone-300 mb-12 leading-relaxed">
            I'm currently seeking opportunities. Let's work together!
          </p>
          ...
          <div className="flex justify-center gap-8 pt-8 border-t border-stone-700">
            ...
            <a href="mailto:schrattwalterdev@gmail.com" className="text-stone-400 hover:text-sky-400 transition-colors">
              <Mail className="w-6 h-6" />
            </a>
          </div>
        </div>
